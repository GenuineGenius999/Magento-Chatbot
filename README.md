...
## APIs
- [wit.ai](https://github.com/ion-nnnnn/FacebookBotPHP/blob/master/FacebookBotPHP.php#L85)
- [Telegram API Wrapper](https://github.com/ion-nnnnn/TelegramBotPHP)
- [Facebook API Wrapper](https://github.com/ion-nnnnn/MessengerBotPHP)
